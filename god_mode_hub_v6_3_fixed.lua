--[[
    GOD MODE HUB - MOBILE EDITION v6.3 FIXED
    Interface Moderna | Sub-Abas no Combat | Lógica de Combate Corrigida
...
-- Lógica de Redirecionamento de Tiro (Silent Aim / Magic Bullet)
local function RedirectShots()
...
RunService.Heartbeat:Connect(RedirectShots)

-- Loop de Ações de Combate
task.spawn(function()
    while task.wait() do
        local tool = LocalPlayer.Character and LocalPlayer.Character:FindFirstChildOfClass("Tool")
...
-- ====================================================================================================
-- INTERFACE MOBILE V6.3 (SUB-ABAS)
-- ====================================================================================================
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "GodModeHubV6_3"
...
Title.Size = UDim2.new(1, 0, 1, 0); Title.BackgroundTransparency = 1; Title.Text = "GOD MODE HUB <font color='#8A2BE2'>V6.3 FIXED</font>"
...
print("📱 GOD MODE HUB V6.3 FIXED - SUB-TABS & FIXED LOGIC!")
