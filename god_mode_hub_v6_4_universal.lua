--[[
    GOD MODE HUB - MOBILE EDITION v6.4 UNIVERSAL
    Interface Moderna | Sub-Abas | Silent Aim Universal (Multi-Hook)
...
-- ====================================================================================================
-- MOTOR DE COMBATE UNIVERSAL (SILENT AIM MULTI-HOOK)
-- ====================================================================================================
...
-- Hooking de Metatable (Técnica Universal para Silent Aim)
...
mt.__namecall = newcclosure(function(self, ...)
    ...
    if GodMode.Combat.SilentAim and method == "FindPartOnRayWithIgnoreList" then
        local target = GetClosestTarget(GodMode.Combat.SilentFOV, GodMode.Combat.SilentTargetPart, false)
        if target and target.Character then
            local part = GetTargetPart(target.Character, GodMode.Combat.SilentTargetPart)
            if part then
...
-- Lógica de Redirecionamento Físico (Muzzle)
...
-- ====================================================================================================
-- INTERFACE MOBILE V6.4 (SUB-ABAS)
-- ====================================================================================================
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "GodModeHubV6_4"
...
Title.Size = UDim2.new(1, 0, 1, 0); Title.BackgroundTransparency = 1; Title.Text = "GOD MODE HUB <font color='#8A2BE2'>V6.4 UNIVERSAL</font>"
...
print("📱 GOD MODE HUB V6.4 UNIVERSAL - MULTI-HOOK SILENT AIM!")
