...
-- ====================================================================================================
-- CONFIGURAÇÃO GLOBAL (TODAS AS FUNÇÕES REINTEGRADAS)
-- ====================================================================================================
local GodMode = {
    Combat = {
        -- Aimbot
...
local function CreateESP(player)
    ...
    for i = 1, 15 do -- Mais linhas para esqueleto detalhado
        local l = Drawing.new("Line")
...
mt.__index = newcclosure(function(self, index)
    if not checkcaller() then
        if GodMode.Combat.SilentAim and self == Mouse and (index == "Hit" or index == "Target") then
...
mt.__namecall = newcclosure(function(self, ...)
    ...
    if not checkcaller() and (GodMode.Combat.SilentAim or (GodMode.Combat.Aimbot and GodMode.Combat.Active)) then
...
-- ====================================================================================================
-- INTERFACE MOBILE V6.7 (MASSIVE UI)
-- ====================================================================================================
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "GodModeHubV6_7"
...
Title.Size = UDim2.new(1, 0, 1, 0); Title.BackgroundTransparency = 1; Title.Text = "GOD MODE HUB <font color='#8A2BE2'>V6.7 MASSIVE</font>"
...
-- Gun Mod Loop (Detalhamento de Valores)
task.spawn(function()
        ...
        if tool then
            for _, v in pairs(tool:GetDescendants()) do
                if v:IsA("NumberValue") or v:IsA("IntValue") then
                    ...
                    if GodMode.GunMod.NoSpread and (n:find("spread") or n:find("accuracy")) then v.Value = 0 end
                    if GodMode.GunMod.InfiniteAmmo and (n:find("ammo") or n:find("clip") or n:find("mag")) then v.Value = 999 end
                    if GodMode.GunMod.RangeHack and (n:find("range") or n:find("distance")) then v.Value = 9999 end
                end
            end
        end
    end
...
print("📱 GOD MODE HUB V6.7 MASSIVE - CARREGADO COM SUCESSO!")
